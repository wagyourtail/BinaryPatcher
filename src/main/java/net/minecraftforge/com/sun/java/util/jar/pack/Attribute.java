...
class Attribute implements Comparable<Attribute> {
    ...
    public ConstantPool.Entry getNameRef() { return def.getNameRef(); }
    ...
    static {
        ...
        define(sd, Constants.ATTR_CONTEXT_CLASS, "Signature", "RSH");
        define(sd, Constants.ATTR_CONTEXT_CLASS, "Synthetic", "");
        define(sd, Constants.ATTR_CONTEXT_CLASS, "Deprecated", "");
        define(sd, Constants.ATTR_CONTEXT_CLASS, "SourceFile", "RUH");
        define(sd, Constants.ATTR_CONTEXT_CLASS, "EnclosingMethod", "RCHRDNH");
        define(sd, Constants.ATTR_CONTEXT_CLASS, "InnerClasses", "NH[RCHRCNHRUNHFH]");
        define(sd, Constants.ATTR_CONTEXT_CLASS, "BootstrapMethods", "NH[RMHNH[KLH]]");

        define(sd, Constants.ATTR_CONTEXT_FIELD, "Signature", "RSH");
        define(sd, Constants.ATTR_CONTEXT_FIELD, "Synthetic", "");
        define(sd, Constants.ATTR_CONTEXT_FIELD, "Deprecated", "");
        define(sd, Constants.ATTR_CONTEXT_FIELD, "ConstantValue", "KQH");

        define(sd, Constants.ATTR_CONTEXT_METHOD, "Signature", "RSH");
        define(sd, Constants.ATTR_CONTEXT_METHOD, "Synthetic", "");
        define(sd, Constants.ATTR_CONTEXT_METHOD, "Deprecated", "");
        define(sd, Constants.ATTR_CONTEXT_METHOD, "Exceptions", "NH[RCH]");
        define(sd, Constants.ATTR_CONTEXT_METHOD, "MethodParameters", "NB[RUNHFH]");
        //define(sd, ATTR_CONTEXT_METHOD, "Code", "HHNI[B]NH[PHPOHPOHRCNH]NH[RUHNI[B]]");

        define(sd, Constants.ATTR_CONTEXT_CODE, "StackMapTable",
               ("[NH[(1)]]" +
                "[TB" +
                "(64-127)[(2)]" +
                "(247)[(1)(2)]" +
        ...
        define(sd, Constants.ATTR_CONTEXT_CODE, "LineNumberTable", "NH[PHH]");
        define(sd, Constants.ATTR_CONTEXT_CODE, "LocalVariableTable", "NH[PHOHRUHRSHH]");
        define(sd, Constants.ATTR_CONTEXT_CODE, "LocalVariableTypeTable", "NH[PHOHRUHRSHH]");
    ...
    static {
        ...
        for (int ctype = 0; ctype < Constants.ATTR_CONTEXT_LIMIT; ctype++) {
            if (ctype != Constants.ATTR_CONTEXT_CODE) {
                define(sd, ctype,
                       "RuntimeVisibleAnnotations",   annotationsLayout);
                define(sd, ctype,
                       "RuntimeInvisibleAnnotations",  annotationsLayout);

                if (ctype == Constants.ATTR_CONTEXT_METHOD) {
                    define(sd, ctype,
    ...
    public static String contextName(int ctype) {
        switch (ctype) {
        case Constants.ATTR_CONTEXT_CLASS: return "class";
        case Constants.ATTR_CONTEXT_FIELD: return "field";
        case Constants.ATTR_CONTEXT_METHOD: return "method";
        case Constants.ATTR_CONTEXT_CODE: return "code";
        }
        return null;
    }
    ...
    class ValueStream {
        ...
        public ConstantPool.Entry getRef(int bandIndex) { throw undef(); }
        public void putRef(int bandIndex, ConstantPool.Entry ref) { throw undef(); }
    ...
    class Layout implements Comparable<Layout> {
        ...
        public Layout(int ctype, String name, String layout) {
            ...
            assert(ctype < Constants.ATTR_CONTEXT_LIMIT);
    ...
    class FormatException extends IOException {
        ...
        public FormatException(String message,
            ...
            super(Constants.ATTR_CONTEXT_NAME[ctype]+ " attribute \"" + name + "\"" +
    ...
    void tokenizeLayout(Layout self, int curCble, String layout, List<Layout.Element> col) {
        ...
        for (int len = layout.length(), i = 0; i < len; ) {
            ...
            case 'K':  // reference_type: constant_ref
                kind = EK_REF;
                switch (layout.charAt(i++)) {
                case 'I': e.refKind = Constants.CONSTANT_Integer; break;
                case 'J': e.refKind = Constants.CONSTANT_Long; break;
                case 'F': e.refKind = Constants.CONSTANT_Float; break;
                case 'D': e.refKind = Constants.CONSTANT_Double; break;
                case 'S': e.refKind = Constants.CONSTANT_String; break;
                case 'Q': e.refKind = Constants.CONSTANT_FieldSpecific; break;

                // new in 1.7:
                case 'M': e.refKind = Constants.CONSTANT_MethodHandle; break;
                case 'T': e.refKind = Constants.CONSTANT_MethodType; break;
                case 'L': e.refKind = Constants.CONSTANT_LoadableValue; break;
            ...
            case 'R': // schema_ref
                kind = EK_REF;
                switch (layout.charAt(i++)) {
                case 'C': e.refKind = Constants.CONSTANT_Class; break;
                case 'S': e.refKind = Constants.CONSTANT_Signature; break;
                case 'D': e.refKind = Constants.CONSTANT_NameandType; break;
                case 'F': e.refKind = Constants.CONSTANT_Fieldref; break;
                case 'M': e.refKind = Constants.CONSTANT_Methodref; break;
                case 'I': e.refKind = Constants.CONSTANT_InterfaceMethodref; break;

                case 'U': e.refKind = Constants.CONSTANT_Utf8; break; //utf8_ref
                case 'Q': e.refKind = Constants.CONSTANT_All; break; //untyped_ref

                // new in 1.7:
                case 'Y': e.refKind = Constants.CONSTANT_InvokeDynamic; break;
                case 'B': e.refKind = Constants.CONSTANT_BootstrapMethod; break;
                case 'N': e.refKind = Constants.CONSTANT_AnyMember; break;
            ...
            case EK_REF:
                ...
                if (localRef == 0) {
                    ...
                    globalRef = (localRef >= 0 && localRef < cpMap.length
                                    ...
                                    : null);
                    byte tag = e.refKind;
                    if (globalRef != null && tag == Constants.CONSTANT_Signature
                        && globalRef.getTag() == Constants.CONSTANT_Utf8) {
